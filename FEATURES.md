...
| `@ConfigEntity` | 1 | `RecipeConfig.java:45`, `@ConfigEntity("config/recipes.yml")` |
...
| `@ConfigEntry` | 2 | `RecipeConfig.java:48` (`enabled`) and `:51` (`recipes`) |
