...
import com.ultikits.plugins.recipe.i18n.UltiRecipeLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiRecipeLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiRecipeLanguageCatalogueTest.loadModuleCatalogues()) {
